...
class Celestial:
    ...
    def __init__(self, Cal):
        ...
        #row 2
        sqrts =Button(Cal, text="√",fg='black', bg='#4997d0' , command=self.special1,height=1, width = 7)
        sqrts.grid(row=2, column=0)

        power2=Button(Cal, text="x²",fg='black', bg='#4997d0' , command=self.special2,height=1, width = 7)
        power2.grid(row=2, column=1)

        percent=Button(Cal, text="%",fg='black', bg='#4997d0' , command=lambda:self.press('%'),height=1, width = 7)
        percent.grid(row=2, column=2)

        clear1= Button(Cal, text='C',fg='black', bg='#4997d0',command=self.clear1, height=1, width = 7)
        ...
        plus= Button(Cal, text='+',fg='black', bg='#4997d0',command=lambda:self.press('+'), height=1, width = 7)
        ...
        minus= Button(Cal, text='-',fg='black', bg='#4997d0',command=lambda:self.press('-'), height=1, width = 7)
        ...
        multiply= Button(Cal, text='x',fg='black', bg='#4997d0',command=lambda:self.press('x'), height=1, width = 7)
        ...
        pi=Button(Cal, text="π",fg='white', bg='black' , command=lambda:self.press('π'),height=1, width = 7)
        pi.grid(row=6, column=2)

        divide= Button(Cal, text='÷',fg='black', bg='#4997d0',command=lambda:self.press('÷'), height=1, width = 7)
        divide.grid(row=6,column=3)

        #row 7
        equal= Button(Cal, text='=',fg='black', bg='#4997d0',command=self.equalpress, height=1, width = 26)
        equal.grid(row=7,column=0,columnspan=3)
    
        clear= Button(Cal, text='AC',fg='black', bg='#4997d0',command=self.clear, height=1, width = 7)
